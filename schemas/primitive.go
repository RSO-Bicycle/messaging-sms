...
func readEmail(r io.Reader) (*Email, error) {
	var str = &Email{}
	var err error
	str.Type, err = readEmailType(r)
	if err != nil {
		return nil, err
	}
	str.Email, err = readString(r)
	if err != nil {
		return nil, err
	}
...
func readEmailActivateUser(r io.Reader) (*EmailActivateUser, error) {
	var str = &EmailActivateUser{}
	var err error
	str.Name, err = readString(r)
	if err != nil {
		return nil, err
	}
	str.ActivateUrl, err = readString(r)
	if err != nil {
		return nil, err
	}
...
func readEmailType(r io.Reader) (EmailType, error) {
	val, err := readInt(r)
	return EmailType(val), err
}
...
func writeEmailActivateUser(r *EmailActivateUser, w io.Writer) error {
	var err error
	err = writeString(r.Name, w)
	if err != nil {
		return err
	}
	err = writeString(r.ActivateUrl, w)
	if err != nil {
		return err
	}
...
func writeEmailType(r EmailType, w io.Writer) error {
