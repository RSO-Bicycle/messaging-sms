...
func readSms(r io.Reader) (*Sms, error) {
	var str = &Sms{}
	var err error
	str.Type, err = readSmsType(r)
	if err != nil {
		return nil, err
	}
	str.PhoneNumber, err = readString(r)
	if err != nil {
		return nil, err
	}
...
func readSmsMfa(r io.Reader) (*SmsMfa, error) {
	var str = &SmsMfa{}
	var err error
	str.Code, err = readString(r)
	if err != nil {
		return nil, err
	}
...
func readSmsType(r io.Reader) (SmsType, error) {
	val, err := readInt(r)
	return SmsType(val), err
}
...
func writeSms(r *Sms, w io.Writer) error {
	var err error
	err = writeSmsType(r.Type, w)
	if err != nil {
		return err
	}
	err = writeString(r.PhoneNumber, w)
	if err != nil {
		return err
	}
...
func writeSmsMfa(r *SmsMfa, w io.Writer) error {
	var err error
	err = writeString(r.Code, w)
	if err != nil {
		return err
	}
...
func writeSmsType(r SmsType, w io.Writer) error {
